  ...
  return (
    <div>
      ...
      <div className="container mx-auto my-20 px-4 md:px-6">
        <div className="flex flex-wrap items-center justify-between gap-4" data-aos="fade-up" data-aos-duration="800">
        ...
        <div className="mt-4 space-y-4 text-[#575756]" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
        ...
        <p className="my-8 text-base leading-7 text-[#575756] md:text-lg md:leading-9" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
